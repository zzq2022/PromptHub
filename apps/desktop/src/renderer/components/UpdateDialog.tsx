...
import { getManualBackupStatus } from "../services/backup-status";
...
export function UpdateDialog({
  ...
  const [installSource, setInstallSource] =
    useState<MacInstallSource>("unknown");
      ...
      <div className="rounded-xl border border-amber-500/30 bg-amber-500/10 p-4">
        <div className="flex items-start gap-3">
          ...
          <div className="min-w-0 flex-1">
            ...
            <div
              className={`mt-3 rounded-lg border px-3 py-2 ${backupStatusClass}`}
            >
  ...
  const renderContent = () => {
    ...
    switch (updateStatus.status) {
        ...
        return (
          <div className="space-y-4">
            ...
            <div className="flex flex-col-reverse gap-2 sm:flex-row sm:justify-end">
              ...
              <button onClick={onClose} className={mutedButtonClass}>
      ...
      case "error":
        const isHomebrewError =
          updateStatus.error === t("settings.homebrewUpdateRequired");
        return (
